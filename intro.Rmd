...
str(df)
```
Notice that even though vector in in dataframe df is of class integer, vector b is of class character, and vector c is of class boolean, when binding them together they have been coerced into factors. You'll have to manually transform them into their original class to be able to use them in math operations.
```{r}
