...
<span style="color:  #7a3b2e;">**Got any questions or thoughts you want to share? Go to our [blog-style discussion board](https://www.ml4pp-blog.com/) and leave a comment underneath the post dedicated to the introduction tab of this site.**</span>
...
knitr::include_graphics("/Users/michellegonzalez/Documents/GitHub/Machine-Learning-for-Public-Policy/Images/sup_unsup_re.png")
```
</center>
...
*Indexig with pandas is done using the .iloc[] call. 
*To estimate a linear model (OLS), you'll need to split your data into a dependent Y and independent X variables.
...
We're at the end of this brief intro to Python. Notice that there's a forward structure throughout. We create an object X, which we define to be of class, say, pandas. It's class will let us use that class/library's functions by calling them after a dot: X.summary() will display a summary of the X object. 
...
You can download the Python script by clicking on the button below.
```{r, echo=FALSE}
library(downloadthis)
download_link(
  link = "https://github.com/michelleg06/Machine-Learning-for-Public-Policy/blob/main/Python code/Intro2Python.py",
  button_label = "Download Intro to Python script (.py)",
  button_type = "info",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
