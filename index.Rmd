...
knitr::include_graphics("/Users/michellegonzalez/Documents/GitHub/Machine-Learning-for-Public-Policy/Images/ML4PP2.png")
```
</center>
...
## 1. Gentle Introduction to R and Rstudio

    ·  Introduction to the course
    ·  Introduction to the R statistical programming language with the Rstudio IDE

**Release Date: 30 November 2030**

**Instructors:** Stephan, Alex and Michelle (who will give you a warm welcome!)

<span style="color: orange;"> **Office hours: Monday, 4 December at 6pm CET / 11am GMT-6. Join us online at [The ML4PP Gather Town](https://app.gather.town/app/oHbUVQSaCs7SOToI/ML%20for%20Public%20Policy)** </span>
...
<span style="color: orange;"> **Office hours: Thursday, 14 December at 6pm CET / 11am GMT-6. Join us online at [The ML4PP Gather Town](https://app.gather.town/app/oHbUVQSaCs7SOToI/ML%20for%20Public%20Policy)** </span>

## 3. Classification

    ·  	Crossvalidation
    ·  	Logit: regularisation, confusion matrix, performance metrics
...
<span style="color: orange;"> **Office hours: tbd. Join us online at [The ML4PP Gather Town](https://app.gather.town/app/oHbUVQSaCs7SOToI/ML%20for%20Public%20Policy)** </span>
