...
knitr::include_graphics("/Users/michellegonzalez/Desktop/MachineLearning4PP/Machine-Learning-for-Public-Policy/ML4PP2.png")
```
</center>
...
<span style="color:red">Please note that workshops 1,2, and 5 will be held in person in winter 2022. Workshops 3 and 4 will be held in person in winter 2023. The exact dates will be provided under each title as soon as they are confirmed.</span> 
...
## [1. Introduction to machine learning for policy analysis](https://www.ml4publicpolicy.com/intro.html)
...
*Mandatory*
- An introduction to Statistical learning, Chapter 2 and Chapter 5.1.
...
**Workshop: 28 November, 3pm**

A gentle introduction to R and Rstudio


## [2. Regression (I)](https://www.ml4publicpolicy.com/reg1.html)
...
## [4. Classification](https://www.ml4publicpolicy.com/classification.html)
...
## [5. Fair Machine Learning / Ethics](https://www.ml4publicpolicy.com/fairml.html)
